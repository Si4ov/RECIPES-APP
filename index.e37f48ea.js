...
const init = function() {
    ...
    (0, _paginationViewJsDefault.default).addHandlerRender(constrolPagination);
...
const loadRecipe = async function(id) {
    try {
        const resData = await _helpersJs.AJAX(`${_configJs.API_URL}/${id}?key=${_configJs.KEY}`);
...
const loadSearchResults = async function(querry) {
    try {
        ...
        const resData = await _helpersJs.AJAX(`${_configJs.API_URL}?search=${querry}&key=${_configJs.KEY}`);
        state.search.results = resData.data.recipes.map((res)=>{
            return {
                id: res.id,
                title: res.title,
...
const KEY = "72512a4a-46c4-4b14-93dc-f31b70101dad";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config.js":"k5Hzs","regenerator-runtime":"dXNgZ"}],"7Olh7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        <img src="${this._data.image}" class="recipe__img" alt ='${this._data.title}'/>
    ...
    _generateIngredient(i) {
        return `<li class="recipe__ingredient">
        <svg class="recipe__icon">
          <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
        </svg>
        <div class="recipe__quantity">${i.quantity ? (0, _fractyDefault.default)(i.quantity).toString() : ""}</div>
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./View.js":"gAkKI","fracty":"hJO4d"}],"loVOp":[function(require,module,exports) {
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach((newItem, i)=>{
            const curEl = curElements[i];
            if (!newItem.isEqualNode(curEl) && newItem.firstChild?.nodeValue.trim() !== "") curEl.textContent = newItem.textContent;
            if (!newItem.isEqualNode(curEl)) Array.from(newItem.attributes).forEach((attr)=>curEl.setAttribute(attr.name, attr.value));
        });
    }
    _clear() {
    ...
    renderMessage(message = this._okMessage) {
        const markup = `
      <div class="message">
        <div>
          <svg>
    ...
    renderSpiner() {
        const spiner = this._parentElement;
        const markup = `
        <div class="spinner">
        <svg>
        ...
        spiner.innerHTML = "";
        spiner.insertAdjacentHTML("afterbegin", markup);
    }
}
...
class SearchView {
    ...
    addHandlerSearch(handler) {
        ...
        events.forEach((ev)=>this._parentElement.addEventListener(ev, function(e) {
                e.preventDefault();
                handler();
            }));
    }
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"8eAfY"}],"8eAfY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Reww":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        // PAGE 1 AND NO ANOTHER
        return "";
    }
}
exports.default = new PaginationView();

},{"url:../../img/icons.svg":"loVOp","./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"uOrlR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"8eAfY"}],"bxpSm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"gAkKI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire3a11")
